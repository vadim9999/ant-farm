...
class StreamingHttpHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if self.path == '/start_stream':
            ...
            print(userId)
            print(
                str(self.rfile.read(int(self.headers['Content-Length'])).decode("utf-8")))
            ...
            try:
                ...
                if self.path.endswith(".html"):
                    ...
                    if userId in connectedUsers:
                        ...
                        self.send_header(
                            'Location', '/index.html?id='+str(counter))
                        self.end_headers()
                    else:
                    ...
                    # sotHum = 40
                        ...
                        values = ("0 200; {0:0} 180; {1} 150; {2} 135; {2} 135;".format(
                            int(55/3), int(55/2), 55))
